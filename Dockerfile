FROM ubuntu:14.04.4
MAINTAINER Ivan Miranda <ivan@pengo.com>
...
apt-get update && \
BUILD_PACKAGES="supervisor nginx php5-fpm php5-mysql php-apc php5-curl php5-gd php5-intl php5-mcrypt php5-memcache php5-tidy php5-xmlrpc php5-xsl php5-intl pwgen curl php-pear " && \
